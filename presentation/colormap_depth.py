...
def visualize_disp_cv(disp_t, cmap=plt.get_cmap("inferno"), vmin=None, vmax=None):
  """
...
dmin = 0.1
dmax = 100.0
depth = cv.imread("/home/milo/datasets/Unity3D/farmsim/pitch1/mav0/depth_image0/data/0000000047250000000.png")
idepth = 1.0 / depth[:,:,0]
print(idepth.shape)
idepth = torch.from_numpy(idepth).unsqueeze(0).clamp(0.0, 5.0)
viz = visualize_disp_cv(idepth, cmap=plt.get_cmap("magma"))
cv.imshow("idepth", viz)
cv.waitKey(0)
